...
let resourceName = 'OperationDefinition';
...
module.exports.update = (args, context, logger) => new Promise((resolve, reject) => {
	...
	resolve({ id: operationdefinition_resource.id, created: false, resource_version: operationdefinition_resource.meta.versionId });
});
