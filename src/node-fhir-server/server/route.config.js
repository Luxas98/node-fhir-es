...
let routes = [
	{
		type: 'get',
		path: '/:base_version/:resource/:id/([$])everything',
		interaction: INTERACTIONS.EVERYTHING,
	},
	{
		type: 'patch',
	...
	{
		type: 'post',
		path: '/:base_version/:resource/search',
		interaction: INTERACTIONS.SEARCH,
	},
	{
		type: 'get',
		path: '/:base_version/:resource/:id/history/:version_id',
		interaction: INTERACTIONS.SEARCH_BY_VID,
	},
	{
		type: 'get',
		path: '/:base_version/:resource/history',
		interaction: INTERACTIONS.HISTORY,
	},
	{
		type: 'get',
		path: '/:base_version/:resource/:id/history',
