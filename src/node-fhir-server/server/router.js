...
function enableSearchRoute(app, config, corsDefaults) {
	let { route } = require('./search/search.config');
...
function setRoutes(options = {}) {
	...
	enableSearchRoute(app, config, corsDefaults);
}
